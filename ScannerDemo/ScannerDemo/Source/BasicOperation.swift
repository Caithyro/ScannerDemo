...
open class BasicOperation: ImageProcessingOperation {
    ...
    public func newTextureAvailable(_ texture: Texture, fromSourceIndex: UInt) {
        ...
        if (UInt(inputTextures.count) >= maximumInputs) || activatePassthroughOnNextFrame {
            ...
            let outputTexture = Texture(device:sharedMetalRenderingDevice.device, orientation: .landscapeRight, width: outputWidth, height: outputHeight, timingStyle: firstInputTexture.timingStyle)
